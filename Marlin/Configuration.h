...
#define STRING_CONFIG_H_AUTHOR "(Pascal Lieverse)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CR-10 Ultimate"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 432.00 }
